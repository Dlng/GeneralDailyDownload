...
>
  ...
  <xsl:template match="/">
    ...
    <xsl:value-of select="concat($special,'Valuation Date (MM/DD/YYYY)',$special,',',$special,'Investment-linked Fund Name',$special,',',$special,'Fund Code',$special,',',$special,'Currency',$special,',',$special,'Buy Price',$special,',',$special,'Sell Price',$special)"/>
    ...
    <xsl:for-each select="//table[@class='data-sheet']/descendant::tr[position()>1]">
      ...
      <xsl:value-of select="concat($Valuation-Date ,',',$Fund-Name,',',$Fund-Code,',',$Currency,',',$BuyPrice,',',$SellPrice)"/>
